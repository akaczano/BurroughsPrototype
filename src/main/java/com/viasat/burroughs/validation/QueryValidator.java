...
public class QueryValidator {
    ...
    private void validateSubquery(SqlSelect select, boolean allowGroup) throws UnsupportedQueryException {
        if (select.getGroup() != null && !allowGroup) {
